...
!function(t, e) {
    ...
    return t.prototype.copyd = function(t) {
        if (this.options.beforeCopy && this.options.beforeCopy(),
            t = t || this.tar.value || this.tar.innerText,
        this.options.copy && (t = this.options.copy()),
        ...
        t.prototype.cut = function() {
            if ("text" === this.tar.type || "textarea" === this.tar.type) {
                if (this.options.beforeCut && this.options.beforeCut(),
                    document.execCommand) {
                    var t = this.tar;
                    if (document.selection) {
                        ...
                        window.getSelection && t.select();
                    document.execCommand("cut")
                }
                window.clipboardData && (window.clipboardData.setData("text", this.tar.value),
                    this.tar.value = ""),
        ...
        t.prototype.paste = function() {
            if ("text" === this.tar.type || "textarea" === this.tar.type) {
                if (this.options.beforePaste && this.options.beforePaste(),
                    document.execCommand) {
                    var t = this.tar;
